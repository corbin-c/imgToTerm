...
const colors = ["000000","800000","008000","808000","000080","800080","008080",
  "c0c0c0","808080","ff0000","00ff00","ffff00","0000ff","ff00ff","00ffff",
  "ffffff","000000","00005f","000087","0000af","0000d7","0000ff","005f00",
  ...
  "875f5f","875f87","875faf","875fd7","875fff","878700","87875f","878787",
  "8787af","8787d7","8787ff","87af00","87af5f","87af87","87afaf","87afd7",
  "87afff","87d700","87d75f","87d787","87d7af","87d7d7","87d7ff","87ff00",
  "87ff5f","87ff87","87ffaf","87ffd7","87ffff","af0000","af005f","af0087",
  "af00af","af00d7","af00ff","af5f00","af5f5f","af5f87","af5faf","af5fd7",
  "af5fff","af8700","af875f","af8787","af87af","af87d7","af87ff","afaf00",
  "afaf5f","afaf87","afafaf","afafd7","afafff","afd700","afd75f","afd787",
  "afd7af","afd7d7","afd7ff","afff00","afff5f","afff87","afffaf","afffd7",
  "afffff","d70000","d7005f","d70087","d700af","d700d7","d700ff","d75f00",
  "d75f5f","d75f87","d75faf","d75fd7","d75fff","d78700","d7875f","d78787",
  "d787af","d787d7","d787ff","d7af00","d7af5f","d7af87","d7afaf","d7afd7",
  "d7afff","d7d700","d7d75f","d7d787","d7d7af","d7d7d7","d7d7ff","d7ff00",
  "d7ff5f","d7ff87","d7ffaf","d7ffd7","d7ffff","ff0000","ff005f","ff0087",
  "ff00af","ff00d7","ff00ff","ff5f00","ff5f5f","ff5f87","ff5faf","ff5fd7",
  "ff5fff","ff8700","ff875f","ff8787","ff87af","ff87d7","ff87ff","ffaf00",
  "ffaf5f","ffaf87","ffafaf","ffafd7","ffafff","ffd700","ffd75f","ffd787",
  "ffd7af","ffd7d7","ffd7ff","ffff00","ffff5f","ffff87","ffffaf","ffffd7",
...
let getColorCode = (color) => {
  ...
  return colors.map((e,code) => {
    e.delta = 0;
    e.rgb.map((value,component) => { e.delta += Math.abs(color[component]-value) });
    closest = (e.delta < closest) ? e.delta:closest;
    return e;
...
let getImageData = (url,width) => {
  ...
  return new Promise((resolve,reject) => {
    img.onload = () => {
      let height = img.height/img.width*width/2;
      let cnv = canvas.createCanvas(width/2, height);
      let ctx = cnv.getContext("2d");
      ctx.drawImage(img, 0, 0, width/2, height);
      resolve(ctx.getImageData(0,0,width/2, height).data);
    };
...
let drawTermPicture = (imgData,w,log=true) => {
  ...
  let drawPixel = (color) => {
    let setColor = (color_code,background=false) => {
      return "["+((background) ? "48":"38")+";5;"+color_code+"m";
    }
    return setColor(getColorCode(color))+"██";
  }
